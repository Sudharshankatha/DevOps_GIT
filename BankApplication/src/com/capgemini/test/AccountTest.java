...
public class AccountTest {
	...
	public void inValidAccount() throws InvalidAccountNumberException 
	{
		accountService.depositAmmount(102, 5000);
	}
	
	@Test
	public void despositSuccessfully() throws InvalidAccountNumberException
	{
		Account account =new Account();
		account.setAccountNumber(101);
		account.setAmount(5000);
		assertEquals(5000, accountService.depositAmmount(101, 5000));
	}
	@Test(expected=com.capgemini.exceptions.InsufficientBalanceException.class)
	public void withDrawMoney() throws InvalidAccountNumberException, InsufficientBalanceException
	{
		accountService.withdrAmount(101, 500);
	}
